...
export default function AdminProductsPage() {
  ...
  // Handle File Upload with Automatic Client-Side Compression
                ...
                <div className="space-y-3 p-4 bg-neutral-950 border border-neutral-800 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div
                      ...
                      className="border-2 border-dashed border-neutral-800 hover:border-snake-green/60 p-4 rounded-lg flex flex-col items-center justify-center text-center cursor-pointer transition-colors bg-black/40 group"
                    >
                      <Upload size={20} className="text-snake-green mb-1 group-hover:scale-110 transition-transform" />
                      <span className="text-white font-bold text-[11px]">UPLOAD IMAGES FROM COMPUTER</span>
                      <span className="text-[10px] text-neutral-400">Select multiple photography files at once</span>
                      <input
                        ref={fileInputRef}
                        type="file"
                        accept="image/*"
                    ...
                    <div className="p-4 bg-black/40 border border-neutral-800 rounded-lg flex flex-col justify-between space-y-2">
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className="flex-1 bg-neutral-900 border border-neutral-800 px-2.5 py-1.5 text-white rounded text-[11px] focus:outline-none focus:border-snake-green font-mono"
                        />
                        <button
                          type="button"
                          onClick={handleAddExternalImageUrl}
                          className="px-3 py-1.5 bg-neutral-800 hover:bg-snake-green hover:text-black text-white font-bold uppercase rounded text-[10px] transition-colors font-mono"
                        >
                          ADD
                        </button>
                      </div>
