...
export default function HomePage() {
  ...
  return (
    <div className="bg-black text-white selection:bg-snake-green selection:text-black">
      ...
      <section
        ref={heroRef}
        className="relative h-screen min-h-[700px] w-full overflow-hidden flex items-end pb-16 md:pb-24 px-6 md:px-12"
      >
        ...
        >
          <div className="max-w-3xl space-y-6">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 bg-black/60 backdrop-blur-md border border-white/10 text-[10px] font-mono tracking-widest text-neutral-300 uppercase"
            >
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-display font-black tracking-tighter leading-[0.88] uppercase text-white"
            >
              WEAR
              <br />
              YOUR
            ...
            <motion.p
              ...
              className="text-sm sm:text-base md:text-lg font-mono text-neutral-300 max-w-md leading-relaxed"
            >
            ...
            >
              <Link
                href="/men"
                className="group relative px-8 py-4 bg-white text-black font-mono text-xs tracking-widest font-bold uppercase transition-all duration-300 hover:bg-snake-green hover:shadow-[0_0_25px_rgba(4,252,33,0.5)] flex items-center gap-2"
              >
                <span>SHOP MEN</span>
              ...
              <Link
                href="/women"
                className="group relative px-8 py-4 bg-black/60 text-white backdrop-blur-md border border-white/20 font-mono text-xs tracking-widest uppercase transition-all duration-300 hover:border-snake-green hover:text-snake-green flex items-center gap-2"
              >
        ...
        <div className="absolute bottom-8 right-6 md:right-12 z-10 hidden sm:flex items-center gap-2 font-mono text-[10px] tracking-widest text-neutral-500 uppercase">
          <span>SCROLL</span>
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <section className="py-28 md:py-40 px-6 md:px-12 border-t border-white/[0.06] relative overflow-hidden bg-[#050505]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-2">
              ...
              <h2 className="text-4xl md:text-7xl font-display font-bold uppercase tracking-tight text-white">
                THE SUPERSNAKE TEE
              </h2>
            </div>
            <p className="text-sm md:text-base font-mono text-neutral-400 max-w-md italic">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-4 space-y-10 order-2 lg:order-1">
              <div className="space-y-2 border-l-2 border-snake-green pl-4">
                ...
                <h4 className="text-lg font-mono font-semibold text-white uppercase">280 GSM SUPIMA® COTTON</h4>
              ...
              <div className="space-y-2 border-l-2 border-neutral-700 pl-4 hover:border-snake-green transition-colors">
                ...
                <h4 className="text-lg font-mono font-semibold text-white uppercase">ZERO-SAG 1-INCH COLLAR</h4>
                <p className="text-xs font-mono text-neutral-400 leading-relaxed">
              ...
              <div className="space-y-2 border-l-2 border-neutral-700 pl-4 hover:border-snake-green transition-colors">
                ...
                <h4 className="text-lg font-mono font-semibold text-white uppercase">BLIND-STITCHED HEMS</h4>
                <p className="text-xs font-mono text-neutral-400 leading-relaxed">
              ...
              <div className="pt-4">
                <Link
                  ...
                  className="inline-flex items-center gap-3 px-6 py-3.5 bg-neutral-900 border border-white/20 text-white hover:border-snake-green hover:text-snake-green font-mono text-xs tracking-widest uppercase transition-all"
                >
            ...
            <div className="lg:col-span-8 order-1 lg:order-2">
              <div className="relative aspect-[4/5] sm:aspect-[16/11] w-full rounded overflow-hidden bg-neutral-950 border border-white/10 group">
                ...
                />
                <div className="absolute bottom-6 left-6 right-6 p-4 bg-black/70 backdrop-blur-md border border-white/10 flex justify-between items-center text-xs font-mono">
      ...
      <section className="relative w-full border-t border-white/[0.06] bg-black">
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-[650px] md:min-h-[800px]">
          {/* Men Editorial */}
          <Link
            href="/men"
            className="group relative overflow-hidden flex flex-col justify-end p-8 md:p-16 border-b md:border-b-0 md:border-r border-white/10"
          >
            ...
            <div className="relative z-10 space-y-4">
              ...
              <h3 className="text-4xl md:text-7xl font-display font-bold uppercase tracking-tight text-white group-hover:text-snake-green transition-colors">
                MEN
              </h3>
          ...
          <Link
            href="/women"
            className="group relative overflow-hidden flex flex-col justify-end p-8 md:p-16"
          >
            <div className="absolute inset-0 z-0 overflow-hidden">
              <Image
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <section className="py-28 md:py-36 px-6 md:px-12 border-t border-white/[0.06] bg-[#080808]">
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <section className="py-28 md:py-36 px-6 md:px-12 border-t border-white/[0.06] bg-[#050505]">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4 group">
              ...
              <h3 className="text-lg font-mono font-bold tracking-wider text-white uppercase group-hover:text-snake-green transition-colors">
                PREMIUM FABRIC
              </h3>
              <p className="text-xs font-mono text-neutral-400 leading-relaxed">
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <section className="py-28 md:py-36 px-6 md:px-12 border-t border-white/[0.06] bg-black">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              <span className="text-[10px] font-mono tracking-widest text-snake-green uppercase">
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <section className="py-36 md:py-52 px-6 md:px-12 border-t border-white/[0.06] bg-black flex flex-col items-center justify-center text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl space-y-8">
          ...
          <h2 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-display font-black tracking-tighter uppercase leading-[0.88] text-white">
            NOT MADE
            <br />
            TO BLEND IN.
          </h2>
